...
exports.config = {
    runner: 'local',
    environment: "QA",
    specs: [`${process.cwd()}/webdriverIO/features/**/*.feature`],
    exclude: [
    ...
    cucumberOpts: {
        ...
        require: [`${process.cwd()}/WebdriverIO/features/step-definitions/**/*.steps.js`],
        backtrace: false,
        requireModule: [],
        dryRun: false,
        failFast: false,
    ...
    onPrepare: function (config, capabilities) {
        if (process.env.RUNNER === "LOCAL" && fs.existsSync("./webdriverIO/allure-results")) {
